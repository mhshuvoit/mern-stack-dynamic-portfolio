        ...
        return (
            <Fragment>
                ...
                <div className={this.state.sideNavClass}>
                    <NavLink> <Link className="my-0 p-2 text-white" to="/dashboard"> <FontAwesomeIcon icon={faHome} /> Dashboard</Link></NavLink>
                    ...
                    <NavLink><Link className="my-0 p-2 text-white" to="/login"> <FontAwesomeIcon icon={faSignOutAlt} /> Logout</Link></NavLink>
                </div>
